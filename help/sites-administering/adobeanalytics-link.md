...
>[!NOTE]
>
>La configuration XSS Antisamy se trouve à présent dans SLING, sous le chemin d’accès **/libs/sling/xss.config.xml**. Les règles suivantes doivent être ajoutées pour que les liens ad hoc fonctionnent :
