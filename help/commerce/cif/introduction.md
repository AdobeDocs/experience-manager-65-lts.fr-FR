...
* L’entreprise doit gérer le contenu produit avec son propre cycle de vie, de manière efficace et omnicanale
...
* Exploitation d’une infrastructure E2E évolutive et stable, conçue pour des performances de pointe (ventes flash, Black Friday, etc.). inclut la recherche unifiée et la gestion du cache

Cette complexité ouvre la porte à de potentielles défaillances, à une augmentation du coût total de possession, à des retards et à une diminution de la valeur relative créée. Ces raisons ont conduit au développement de Commerce Integration Framework (CIF), un module complémentaire d’Experience Manager. Le CIF étend Experience Manager en lui apportant des fonctionnalités de commerce et en standardisant son intégration à un moteur de commerce. Résultat : une solution évolutive, stable et à l’épreuve du temps, avec un coût total de possession plus faible. Il libère l’innovation technique et métier grâce à des outils agiles et à des fonctionnalités parfaitement intégrées, afin de créer des expériences de commerce attrayantes.

![Éléments du module CIF](./assets/CIF/CIF_Overview.png)

## Prise en charge efficace des clients par le module CIF depuis 2013

Avec plus de 200 clients, CIF s’est imposé comme un élément clé pour la réussite des projets de contenu et de commerce. Il offre une valeur ajoutée à l’informatique et aux activités des entreprises, dès aujourd’hui et pour l’avenir. Comme le décrivent des projets récents de clientes et clients, CIF est un « incroyable accélérateur de développement et offre un gain de temps considérable pour générer une valeur importante ».
...
Le module complémentaire CIF apporte du contexte de produit à Experience Manager et fournit des outils de création tels qu’une console de produits et des sélecteurs de produits ou de catégories qui permettent au responsable marketing de créer et de diffuser des expériences d’achat dans Experience Manager sans faire appel au développeur ou à la développeuse. Voici ses avantages :
...
CIF est conçu pour permettre une innovation continue grâce à un module complémentaire toujours à jour, qui offre aux clients un accès permanent à de nouvelles fonctionnalités améliorées.
...
CIF prend en charge les clients dotés de modèles d’intégration normalisés et basés sur les bonnes pratiques. Il aide les clients à réussir dès aujourd’hui et reste suffisamment flexible pour évoluer avec eux et s’adapter à leurs besoins futurs :
