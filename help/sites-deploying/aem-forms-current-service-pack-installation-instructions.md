...
<span class="preview"> Si vous effectuez une mise à niveau vers le pack de services 6.5 LTS d’AEM Forms, reportez-vous à la section [Mise à niveau vers AEM Forms 6.5 LTS sur OSGi](/help/forms/using/upgrade-forms-osgi.md). </span>
...
* [AEM Service Pack](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/release-notes.html?lang=fr)
  <!--* [Forms add-on package](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=fr)-->
...
+++&#x200B;6. Installer le pack de services AEM
...
+++&#x200B;7. Installez le package complémentaire AEM Experience Manager Forms.
...
+++&#x200B;4. Installer le pack de services AEM
