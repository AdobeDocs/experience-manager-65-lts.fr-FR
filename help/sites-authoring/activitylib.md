...
1. Dans la console Activités, cliquez sur **Créer**, puis sur **Créer une marque**.
...
1. Cliquez sur la marque, puis sur la zone contenant l’activité que vous souhaitez publier ou dépublier.
