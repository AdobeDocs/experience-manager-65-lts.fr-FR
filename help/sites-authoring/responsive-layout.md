...
>
>Pour l’administration et le développement de vos sites, les détails de configuration du conteneur de mise en page sont décrits dans le document [Configuration du conteneur de mise en page et du mode Mise en page](/help/sites-administering/configuring-responsive-layout.md).
