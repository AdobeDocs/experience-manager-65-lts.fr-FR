...
description: Découvrez comment prévisualiser des ressources, telles que des vidéos et des images, dans Dynamic Media, en appliquant des paramètres d’image et de visionneuse prédéfinis.
...
* [Application de paramètres d’image prédéfinis](/help/assets/image-presets.md)
