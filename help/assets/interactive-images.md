...
Lorsque vous ajoutez des zones réactives à une image de bannière dans Experience Manager Assets, vous devez affecter un SKU (unité de gestion des stocks) et des variables supplémentaires facultatives à chaque zone réactive. Ces variables de zones réactives seront utilisées ultérieurement pour faire correspondre ces zones réactives avec du contenu d’aperçu rapide.

Il est important d’identifier correctement le nombre et le type des variables à associer aux données des zones réactives. Chaque zone réactive ajoutée à une image de bannière doit comporter suffisamment d’informations pour identifier clairement le produit sur le système principal existant.
...
Vous pouvez à présent charger une bannière d’image et à y ajouter des zones réactives à l’aide de la fonctionnalité d’images interactives Shoppable d’Experience Manager Assets.
...
1. Chargez les bannières d’images que vous souhaitez rendre interactives.
   ...
   Vous pouvez à présent ajouter des zones réactives à la bannière d’image. Reportez-vous à la tâche suivante ci-dessous.
...
1. Publiez l’image interactive. La publication permet de fournir la bannière par le biais du cloud et génère également le code intégré si vous avez besoin de l’intégrer à un site web tiers.
   ...
   Une fois que vous avez ajouté des zones réactives et publié l’image interactive, vous pouvez l’ajouter à votre site web.
...
Une fois que vous avez chargé une image de bannière, ajouté des zones réactives à l’image et publié l’image interactive, vous pouvez l’ajouter à une page de votre site web.
