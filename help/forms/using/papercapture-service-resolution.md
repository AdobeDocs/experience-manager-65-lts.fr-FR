...
1. Redémarrez le serveur d’applications AEM.
   ...
   >[!NOTE]
   >
   >Adobe vous recommande d&#39;utiliser la commande `Ctrl + C` pour redémarrer le SDK. Le redémarrage du SDK AEM à l’aide de méthodes alternatives, par exemple l’arrêt des processus Java, peut entraîner des incohérences dans l’environnement de développement AEM.
