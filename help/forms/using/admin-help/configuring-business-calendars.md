...
1. [Facultatif] Pour définir ce calendrier comme calendrier par défaut, sélectionnez Calendrier par défaut. Le calendrier par défaut est utilisé lorsqu’il n’existe aucune autre association de calendrier pour des événements associés à l’utilisateur ou l’utilisatrice, ou si aucun calendrier professionnel n’est spécifié pour l’événement Retardateur ou le service d’attente. Vous ne pouvez pas supprimer le calendrier par défaut.
