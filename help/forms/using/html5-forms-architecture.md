...
Vous avez besoin du package complémentaire AEM Forms pour activer les formulaires HTML5. Pour plus d’informations sur l’installation du package complémentaire AEM Forms, voir [Installation et configuration d’AEM Forms](../../forms/using/installing-configuring-aem-forms-osgi.md).
...
Pour plus d’informations sur les widgets et les contrats correspondants, voir [Widgets personnalisés pour formulaires HTML5](/help/forms/using/introduction-widgets.md).
