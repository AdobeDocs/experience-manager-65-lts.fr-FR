...
description: Découvrez comment ajouter des points d’entrée tels qu’EJB, SOAP, Watched Folder, Email endpoint et Remoting endpoint et modifier, supprimer et récupérer des points d’entrée à l’aide de Java&trade; API.
contentOwner: admin
...
L’exemple de code Java™ suivant ajoute un point d’entrée de courrier électronique à un service nommé *MyApplication/EncryptDocument* t. (Voir [Ajouter des points d’entrée Email](/help/forms/developing/programmatically-endpoints.md#adding-email-endpoints).)
