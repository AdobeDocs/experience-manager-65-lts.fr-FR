...
+ Implémentation {#implementing}
   + Développement {#developing}
      ...
      + Gestion de l’expérience découplée {#headless}
         ...
         + Parcours découplés {#journeys}
            + Parcours de développement découplé {#developer}
               + [Comprendre le découplage dans AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/overview.html)
               ...
               + [Prise en main d’AEM découplé as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/getting-started.html)
               + [Premiers pas vers votre première expérience d’utilisation d’AEM découplé](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/path-to-first-experience.html)
               + [Comment modéliser votre contenu en tant que modèles de contenu AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/model-your-content.html)
            ...
            + Parcours d’architecte de contenu découplé {#architect}
               + [Aperçu du parcours d’architecture de contenu découplé AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/overview.html)
         ...
         + Fragments de contenu{#content-fragments}
            ...
            + [Activation de la fonctionnalité de fragments de contenu pour votre instance](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-configuration-browser.html)
      ...
      + Développement hybride et SPA AEM {#spas}
         ...
         + [Activation de l’exportateur JSON pour un composant](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/components/json-exporter-components.html)
