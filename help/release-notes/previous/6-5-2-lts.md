---
title: Notes de mise à jour actuelles pour Adobe Experience Manager 6.5 LTS, Pack de services 2
description: Recherchez les informations sur la version actuelle d’Adobe Experience Manager 6.5 LTS, Pack de services 2.
...
# Notes de mise à jour actuelles pour Adobe Experience Manager 6.5 LTS, Pack de services 2 {#release-notes}
...
* Amélioration de l’expérience d’utilisation dans l’éditeur visuel de règles. Cette mise à jour inclut les fonctionnalités suivantes :
  ...
  * Affichage des boutons Ajouter et Supprimer et possibilité de les activer ou désactiver au lieu de les masquer
...
* Suppression des rôles de grille ARIA et de cellule de grille de la liste des ressources du rail latéral. Restauration de la sémantique de liste standard et de l’ordre de focus au clavier, ce qui améliore la navigation avec le lecteur d’écran et réduit le nombre de points d’arrêt de tabulation supplémentaires. (SITES-25361)
...
* Correction du dépassement de la disposition dans la fenêtre contextuelle Search Assets à une largeur de fenêtre d’affichage de 320 px. Le contenu de la fenêtre contextuelle est désormais redistribué et reste lisible, de sorte que les contrôles ne se chevauchent plus ou ne dépassent plus la boîte de dialogue. (SITES-25330)
...
* Correction de l’ordre de tabulation au clavier de la barre d’outils Démographique pendant la navigation dans l’aperçu de la disposition. La navigation tabulaire passe désormais directement du bouton Démographique aux commandes de la barre d’outils, sans passer à la barre d’outils secondaire. (SITES-25305)
...
* Les liens Définir la date et Quitter Distorsion du temps ne comportaient pas d’indicateur de focus visible lors de la navigation au clavier. L’interface d’utilisation affiche désormais un style de focus distinct et à fort contraste pour pouvoir identifier le lien actif en un coup d’œil. (SITES-25232)
* L’en-tête contextuel du teaser ne bloque plus le déplacement de la boîte de dialogue à l’aide du clavier. Les commandes au clavier permettent désormais de saisir, déplacer et déposer des éléments, ce qui améliore l’accessibilité pour les lecteurs d’écran ainsi que la maniabilité globale. (SITES-25226)
...
* Correction de commentaires NVDA incorrects lors de la navigation par nuance dans la boîte de dialogue contextuelle Préférences utilisateur. NVDA lit désormais le libellé de la nuance qui reçoit le focus, ce qui élimine les informations de couleur trompeuses. L’ensemble d’échantillons prend désormais en charge une navigation au clavier cohérente et une perception claire de la sélection. (SITES-24739)
* Réduction de la verbosité de la sortie NVDA pour la commande `Spin`. Suppression de l’étiquetage de groupe redondant qui dupliquait le libellé d’entrée, de sorte que NVDA annonce le nom de la commande une seule fois. La navigation au clavier et avec le lecteur d’écran fournit désormais une seule annonce claire. (SITES-24725)
* La boîte de dialogue Carrousel place désormais le focus sur l’en-tête de boîte de dialogue au lieu de l’onglet Éléments. Les commandes Annuler et Échap restaurent le focus sur la commande ayant lancé la boîte de dialogue, ce qui réduit la quantité de messages vocalisés par NVDA. (SITES-24716)
* La boîte de dialogue Sélection de lien aligne désormais le libellé de programmation sur le libellé à l’écran pour les éléments de l’arborescence de dernier niveau. La navigation à l’aide des touches fléchées déclenche une annonce fiable du lecteur d’écran pour chaque élément et supprime le rendu de libellé trompeur. (SITES-24710)
...
* La boîte de dialogue de sélection d’ouverture de lien restaure désormais le focus au clavier sur le déclencheur de boîte de dialogue après Fermer ou Annuler. Le focus ne passe plus au champ Lien, ce qui maintient le contexte du lecteur d’écran stable et réduit les étapes de navigation. (SITES-24707)
* La boîte de dialogue contextuelle de l’image suit désormais une séquence de focus logique. Le focus n’ignore plus les commandes précédentes et ne se place plus sur le repère de page après Annuler, et les personnes retrouvent le focus sur le bouton Configurer après la fermeture. (SITES-24693)
* La boîte de dialogue contextuelle Rail des références verrouille désormais le focus au clavier. La touche de tabulation et Maj+Tab font toujours partie des commandes de boîte de dialogue et le focus ne quitte plus le contenu de la page. Les lecteurs d’écran n’annoncent que le contenu de la boîte de dialogue. (SITES-24683)
* La boîte de dialogue contextuelle Sélection du chemin d’accès hypertexte met désormais le focus sur l’en-tête de boîte de dialogue lors de l’ouverture. La commande Annuler ferme la boîte de dialogue et restaure le focus sur le bouton de boîte de dialogue Ouvrir, ce qui empêche la perte de focus et les messages redondants du lecteur d’écran. (SITES-24672)
* Le champ de recherche utilise désormais un libellé persistant à l’écran au lieu du texte d’espace réservé. Le libellé reste visible lors de la saisie, ce qui améliore la clarté pour les personnes utilisant un clavier, un lecteur d’écran et un système vocal. (SITES-24529)
...
* Le panneau Ressources du rail latéral comprend désormais une commande Fermer. L’action Fermer renvoie le focus clavier au bouton bascule Rail latéral et empêche la navigation forcée par tabulation dans le contenu du panneau. (SITES-24489)
...
* Sites Admin supprime désormais le rôle d’image des icônes de miniatures de dossier. La technologie d’assistance ignore ces éléments décoratifs, en se concentrant sur les noms de dossier et les actions. (SITES-2852)
* L’arborescence de contenu achemine désormais le focus du clavier vers l’élément actif de l’arborescence ou vers le premier élément. Le conteneur d’arborescence n’agit plus comme un arrêt de tabulation vide, ce qui empêche les pièges de focus avec Maj+Tabulation. (SITES-1577)

#### Interface d’utilisation d’administration{#sites-adminui-65-lts-sp2}

Les paramètres de la vue Liste de la console Sites ne reflétaient pas les colonnes affichées en vue Liste. La boîte de dialogue s’est ouverte avec des cases à cocher décochées et un nombre incorrect de colonnes sélectionnées. La boîte de dialogue de synchronisation des correctifs affiche les colonnes de grille actives et met à jour le compteur pour qu’il corresponde à la visibilité réelle des colonnes. (SITES-38576)

#### Interface d’utilisation classique{#sites-classicui-65-lts-sp2}

Après une mise à niveau, la modification du composant de texte dans l’interface d’utilisation classique affichait des balises HTML brutes au lieu de texte enrichi. Le pack de services 2 corrige le rendu de l’éditeur de texte enrichi de l’interface d’utilisation classique afin que l’éditeur affiche le contenu formaté et conserve les balises stockées. Le correctif empêche également l’extension des balises lors de modifications et d’enregistrements répétés. (SITES-38709)

#### [!DNL Content Fragments]{#sites-contentfragments-65-lts-sp2}

La prise en charge des événements découplés ne comportait pas les événements OSGi requis pour les fragments de contenu et les modèles dans 6.5 LTS. La mise à jour ajoute le bundle d’eventing ainsi que les dépendances requises et inclut un build LTS 6.5. Les événements de fragment de contenu et de modèle se déclenchent désormais correctement et prennent en charge les workflows de l’API Launches. (SITES-35329)
...
* Une régression a interrompu le mode Liste de la console Ressources pour les fragments de contenu et déclenché une erreur lors du rendu de la liste. La mise à jour corrige la logique de vue Liste après la suppression des informations d’aperçu et restaure une sortie de liste stable. La console affiche désormais les fragments de contenu sans échec et permet de conserver les interactions de liste utilisables. (SITES-38683)
* L’éditeur de fragment de contenu localise désormais le libellé Tags. L’éditeur localise également le libellé Collections, de sorte que le texte de l’interface d’utilisation correspond aux paramètres régionaux sélectionnés. (SITES-977)


#### [!DNL Content Fragments] - Éditeur de fragments{#sites-fragments-editor-65-lts-sp2}

* Les balises de variation de fragment de contenu disparaissaient lorsque le bouton bascule de fonctionnalité restait désactivé après le refactorage. Le correctif restaure la prise en charge des balises de variation même lorsque ce bouton est désactivé. Les créateurs et créatrices peuvent à nouveau ajouter et consulter des balises de variation dans l’éditeur de fragment de contenu. (SITES-38682) CRITIQUE
* Les fragments de contenu modifiés disparaissaient de la liste de la console Assets lorsque les créateurs et créatrices revenaient de l’éditeur de fragment de contenu. La mise en cache du navigateur a renvoyé une liste obsolète et a masqué le fragment mis à jour jusqu’à une actualisation manuelle. Le correctif ajoute la gestion du contrôle du cache pour le chemin de retour de l’éditeur afin que la liste se recharge correctement et que le fragment modifié reste visible. (SITES-35374) CRITIQUE

* Le RTE de fragment de contenu présentait des problèmes de disposition et d’affichage après de récentes modifications de style de l’interface d’utilisation. Le pack de services 2 affine le style du RTE afin que la barre d’outils et la zone modifiable s’affichent correctement et restent lisibles. L’éditeur de fragment de contenu s’aligne désormais sur l’aspect et le comportement de l’éditeur de page. (SITES-38684)
* La suppression des portées IMS du sélecteur de ressources Polaris interrompait l’intégration du fragment de contenu au point d’entrée de diffusion. Les créateurs rencontrent des erreurs lorsqu’ils ouvrent le sélecteur de ressources distantes et sélectionnent des ressources. La mise à jour ajoute à nouveau les portées IMS nécessaires et restaure un accès stable au tier de diffusion. (SITES-35837)
...
* L’explorateur GraphQL n’échoue plus lorsqu’un nom de navigateur de configurations contient des caractères CJK. La création du point d’entrée et l’accès aux requêtes enregistrées fonctionnent normalement et la page de le requêteur GraphQL ne comporte pas d’erreur. (SITES-31616)

#### [!DNL Content Fragments] - Éditeur de modèles{#sites-model-editor-65-lts-sp2}

* Les modèles de fragment de contenu imbriqués cessaient de fonctionner lorsque la refactorisation liait la fonctionnalité à un bouton (bascule) désactivé. Le correctif restaure la prise en charge des modèles imbriqués sans nécessiter de modifications de la bascule. Les créateurs et créatrices peuvent à nouveau créer et utiliser des modèles imbriqués dans l’éditeur de modèles. (SITES-38681) CRITIQUE
...
* L’éditeur de modèle de fragment de contenu effectue désormais le rendu des chaînes localisées pour la boîte de dialogue d’avertissement de verrouillage. L’interface d’utilisateur remplace les messages en anglais non localisés par des ressources de paramètres régionaux dans les langues prises en charge. (SITES-28592)

#### [!DNL Content Fragments] - API REST{#sites-restapi-65-lts-sp2}

AEM en mode découplé nécessitait une branche de version dédiée pour éviter les conflits de dépendances et de versions de bundles avec les builds principaux. La mise à jour ajoute une branche `release/6.5lts` en mode découplé et aligne les jeux de dépendances et les versions de bundle. Jenkins crée désormais correctement la base de code découplée sans collisions de versions. (SITES-36585)

<!-- #### Component console{#sites-component-console-65-lts-sp2} -->

#### API de contenu{#sites-content-api-65-lts-sp2}

Un défaut de basculement de fonctionnalité signalait de manière incorrecte le statut de l’API Page Management. La mise à jour ajoute un indicateur d’activation dédié et l’évalue avec l’option de bouton bascule existante. L’API Page Management affiche désormais un statut stable. L’API Site Management reste expérimentale. (SITES-39284)
...
* L’interface d’utilisation Lancements affichait les contrôles de lancement de fragment de contenu même si le produit n’exposait pas les lancements de fragment de contenu dans l’interface d’utilisation tactile. Cette modification supprime les chemins de code du lancement de fragment de contenu de cq-launches-content et ajuste le filtrage de la liste de lancement. Les créateurs et créatrices voient désormais les options de lancement de page cohérentes sans les entrées de lancement de fragment de contenu. (SITES-35633)
* Le démarrage rapide d’AEM 6.5 LTS ne comportait pas les bundles Launches requis ni les conditions préalables, ce qui bloquait l’activation de Launches OpenAPI. La mise à jour ajoute les bundles de lancements et les dépendances requises, telles que la prise en charge des mesures, les mises à jour DAM-cfm et la configuration de la file d’attente. Les API de lancement s’exécutent désormais sur Quickstart 6.5 LTS avec les composants d’exécution requis présents. (SITES-35297)
* Le packaging des lancements de fragments de contenu regroupait de nouvelles versions de dépendance et des bibliothèques GraphQL inutiles, ce qui compliquait l’intégration à AEM 6.5 LTS. Cette modification aligne les versions de dépendance sur la référence LTS d’AEM 6.5 et supprime les dépendances GraphQL inutilisées. La résolution de bundle est désormais cohérente et le démarrage des lancements CF reste stable. (SITES-35295)
...
* AEM 6.5 LTS comprend désormais un bundle launches-core mis à jour avec des versions de dépendances alignées. La mise à jour ajoute une gestion par le module launches-core pour les types de données UUID de fragment et UUID de référence. Le traitement de lancement conserve désormais un comportement cohérent dans les lancements et les workflows de fragments de contenu. (SITES-35290)
...
#### MSM - Copies dynamiques{#sites-msm-live-copies-65-lts-sp2}

* Les administrateurs et administratrices disposaient d’une visibilité limitée sur le traitement MSM d’envoi lors de la modification du contenu. Le correctif ajoute un enregistrement détaillé autour de la réception des événements MSM et de l’exécution du déploiement. La sortie de débogage affiche désormais les événements déclenchés, les chemins de contenu modifiés et la personne à l’origine de la modification. (SITES-38029)
* AEM a corrigé un problème de mise en page lié à la localisation dans le champ de date Déploiement du plan directeur. L’invite de date s’adapte désormais au contrôle et reste lisible dans les langues prises en charge, y compris `fr_FR`. (SITES-14961)

<!-- #### Page editor{#sites-pageeditor-65-lts-sp2} -->

#### Réplication{#sites-replication-65-lts-sp2}

La publication de l’éditeur de page gère désormais les URL contenant des sélecteurs ou des suffixes. La requête publiée envoie désormais le chemin d’accès à la page JCR, et non une chaîne d’URL de sélecteur ou de suffixe, de sorte que l’activation se termine et que le contenu est mis en ligne. La réplication renvoie désormais un statut d’erreur en cas d’échec, ce qui empêche les faux messages « publication démarrée ». (NPR-43288)
...
* Correction d’un problème en raison duquel l’option Sélectionner une miniature de la boîte de dialogue des propriétés vidéo n’ouvrait pas le sélecteur de ressources, ce qui restaurait la possibilité pour les utilisateurs et utilisatrices de choisir des miniatures personnalisées pour les ressources vidéo. (Assets-58926)
* Dans la vidéo Dynamic Media, la prise en charge de la sélection de l’arabe a été ajoutée dans la liste déroulante Langue des sous-titres et des pistes audio, ce qui permet aux auteurs et autrices de gérer les sous-titres arabes directement dans AEM. (Assets-61771)

<!-- #### [!DNL Dynamic Media] - Hybrid Mode {#assets-dm-hybrid-65-lts-sp2} -->

### [!DNL Forms]{#forms-65-lts-sp2}

* La fonctionnalité `Data Source / Enter Keyword` de l’éditeur de modèle de données de formulaire (FDM) rencontrait des problèmes, Ce problème affectait la capacité à effectuer des recherches et à sélectionner des sources de données. (FORMS-23971)
* Sur les appareils mobiles, le composant Tableau dans les formulaires adaptatifs affichait un en-tête masqué en haut de la page, ce qui entraînait une mauvaise annonce du contenu par les lecteurs d’écran. Ce problème affectait les personnes utilisant des lecteurs d’écran pour la navigation. (FORMS-23754)
...
* L’envoi du formulaire échoue après la mise à niveau vers AEM 6.5 LTS SP1. L’élément com.adobe.cq.social.commons.CollabUtil était manquant, ce qui provoquait des erreurs de compilation JSP et des échecs des actions par e-mail. (FORMS-23457)
* Des problèmes de traduction incorrecte de hCaptcha se produisaient dans les formulaires adaptatifs basés sur les composants principaux. Cela affectait la capacité des personnes non anglophones à remplir avec précision les formulaires. (FORMS-23426)
* Les personnes rencontraient des échecs d’envoi de formulaire avec une exception SAXParseException : « Le contenu n’est pas autorisé dans le prologue » (HTTP 500). Ce problème se produisait en raison d’une valeur null dans le code XML des données de préremplissage, ce qui entraînait l’échec de l’analyse XML côté serveur. (FORMS-22633)
* Les formulaires adaptatifs échouaient aux audits WCAG (Web Content Accessibility Guidelines). Ce problème est dû à un balisage de navigation par tabulation du formulaire non valide. En d’autres termes, un élément hors liste est rendu en tant qu’enfant direct d’une liste, où seuls les éléments de liste sont autorisés. Ce problème empêchait le formulaire de réussir les programmes de validation d’accessibilité et affectait les organisations qui doivent respecter des exigences légales ou de conformité interne. (FORMS-22101)
* Des problèmes d’accessibilité se produisaient dans le document d’enregistrement (DoR) / le PDF d’envoi où les champs de formulaire vides n’étaient pas balisés en tant qu’éléments de formulaire. Cela entraînait des difficultés pour les lecteurs d’écran, ce qui affectait la capacité des personnes en situation de handicap à naviguer dans les formulaires et à les remplir efficacement. (FORMS-21989)
...
* Les utilisateurs et utilisatrices ont rencontré une vulnérabilité de sécurité dans le tableau de bord des formulaires adaptatifs. Plus précisément, un problème XSS (cross-site scripting) a été identifié dans le fichier startpointcontrol.js, ce qui peut potentiellement permettre l’exécution de scripts malveillants. (FORMS-20679)
...
**Les problèmes suivants ont été corrigés dans le pack de services 2 JEE d’AEM Forms 6.5 LTS (version 6.6.0-0006). Pour les appliquer, [téléchargez et installez le correctif](/help/forms/using/adobe-experience-manager-forms-65-lts-hotfixes.md).**

* Après la mise à jour d’Apache Shiro vers la version 2.1.0, AEM Forms sur JEE n’a pas pu démarrer avec une `NoClassDefFoundError` pour le gestionnaire de sécurité Shiro. Le démarrage est maintenant terminé. (FORMS-26818)
* Échec d’AEM Forms on JEE avec une erreur « aucune classe trouvée » pour `org.owasp.esapi.reference.JavaLogFactory`. La classe manquante est maintenant résolue. (FORMS-26819)
* Après la mise à niveau vers AEM Forms 6.5 LTS, les points d’entrée TaskManager ont été supprimés. Les points d’entrée sont désormais conservés. (FORMS-26584, FORMS-26589)
* Sous JEE, l’étape Configuration Manager MergeEars a échoué avec une erreur de déclaration DOCTYPE (`ALC-LCM-010-200`) en raison du créateur XML sécurisé. MergeEars est maintenant terminé. (FORMS-26569)
* Les journaux au niveau de l’application étaient manquants sur les déploiements d’® WebSphere® Liberty. La journalisation au niveau de l’application est maintenant restaurée. (FORMS-25063)
* Dans JBoss®, l’e-mail a échoué avec « IMAPProvider not a subtype ». L’e-mail fonctionne désormais sur JBoss®. (FORMS-24892)
* Sur WebSphere® Liberty Profile (WLP), l’e-mail a échoué avec « Impossible de convertir le socket en TLS ». Les e-mails via TLS fonctionnent désormais sur WLP. (FORMS-24692)
* Mise à jour de la bibliothèque Gibson vers la version 6.0.29665850. (FORMS-26688)
* Améliorations de la validation des assertions SAML rétroportées. (FORMS-25222)
* Mise à jour d’Apache Log4j vers la version 2.25.5. (FORMS-26733, FORMS-26734)
* Ce correctif comprend également des correctifs de sécurité.
...
* AEM évite désormais les entrées ACL en double pour le groupe `contributor` dans l’élément `WEB-INF/resources/provisioning/model.txt` généré. Le fichier WAR contient désormais un bloc ACL cohérent, ce qui évite des différences d’autorisations déroutantes lors de la vérification. (GRANITE-63269)
...
CRXDE Lite n’affiche plus d’onglet vide lors de l’ouverture d’un fichier JSP après une mise à niveau du pack de services. AEM est désormais livré avec le code principal et le code du module complémentaire CodeMirror correspondants, ce qui empêche l’erreur fatale du navigateur et permet à l’éditeur de rester utilisable. (GRANITE-64333)

#### Granite{#foundation-granite-65-lts-sp2}

Le programme de validation de la sécurité des expressions gère désormais les valeurs de configuration OSGi vides ou nulles. Il applique des valeurs par défaut sécurisées, ignore les tableaux vides et enregistre des journaux explicites, empêchant les NullPointerException et les résultats de validation imprévisibles. (NPR-43163)
...
* Sling met à jour la liste autorisée de connexion d’administration pour utiliser une terminologie inclusive et de nouveaux PID de configuration. Cette modification s’aligne sur la base Sling JCR 3.2.0. (GRANITE-63756)
  ...
  * Sling assure toujours une rétrocompatibilité partielle pour les PID obsolètes, mais ne les utilises pas pour les nouvelles configurations. Utilisez plutôt les PID `LoginAdminAllowList.*` plus récents.
  * N’exécutez pas simultanément des configurations de liste autorisée obsolètes et nouvelles. Des configurations mixtes peuvent créer de l’ambiguïté et produire un comportement inattendu. Lorsque vous migrez vers AEM 6.5 LTS SP2, supprimez complètement les PID obsolètes.
...
* AEM 6.5 LTS SP2 met à jour l’ensemble de bundles de la couche de base pour Sling, Oak et Felix. Ces mises à niveau renforcent la stabilité du temps d’exécution et harmonisent les versions des dépendances sur l’ensemble de la plateforme. (GRANITE-61874)
...
Le SP2 pour AEM 6.5 LTS est fourni sous la forme d’un fichier JAR de démarrage rapide plutôt que d’un fichier ZIP à installer via le gestionnaire de modules. Les clients et clientes sur site effectuent la mise à niveau en remplaçant le fichier JAR de démarrage rapide, en le décompressant, puis en redémarrant. Cette méthode est conforme à la procédure de mise à niveau sur place d’Adobe.
...
Il est conseillé aux clients de vérifier s’ils utilisent la fonctionnalité dans leur déploiement actuel. Les clients et clientes sont invités à prévoir la modification de leur mise en œuvre afin d’utiliser l’alternative fournie.
...
>[!CAUTION]
>
> Supprimez tous les commentaires des fichiers JSON dans les bundles `Sling-Initial-Content` pour éviter les échecs de chargement de contenu après la mise à niveau vers AEM 6.5 LTS SP2.
